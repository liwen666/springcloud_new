...
//        Integer canFetch = merchantFullDto.getPower().getCanFetch();// 领取权限开关
  ...
  @Test
    public void getFullDto() {
        Result<Page<MerchantFullDto>> pageFullMerchant = merchantService.getPageFullMerchant(1, 100);
...
//        Result<Map<String, Object>> mapResult = merchantService.getAlertMerchant(1l, MerchantAlterItemEnum.REALNAME);
        Result<Map<String, Object>> mapResult = merchantService.getAlertMerchant(1l, MerchantAlterItemEnum.PAYMENT_WAY);
