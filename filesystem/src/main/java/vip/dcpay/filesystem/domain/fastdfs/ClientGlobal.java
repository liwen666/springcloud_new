...
package vip.dcpay.filesystem.domain.fastdfs;


import vip.dcpay.filesystem.common.IniFileReader;
...
//    Properties props = new Properties();
    ...
    if (in != null) {
      FileDfsConfig.properties.load(in);
//      props.load(in);
    }
//    initByProperties(props);
    initByProperties( FileDfsConfig.properties);
  }
