...
public enum TableDataTypeEnum {
    ...
    TableDataTypeEnum(String feature, String desc, String driver, String keywordPrefix, String keywordSuffix, String aliasPrefix, String aliasSuffix) {
    ...
    public static String  getAliasPreFix(String type) {
        TableDataTypeEnum greenplum = TableDataTypeEnum.valueOf(type);
