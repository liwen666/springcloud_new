...
import static jrx.data.hub.domain.enums.DataTimeFormat.*;
...
public enum ValueType {
    ...
    LONGSTR(17, "长字符串", String.class, "VARCHAR"),
    OBJECT(18, "对象", Object.class, "VARCHAR");
...
//        return null;
    ...
    public Object normalizeValue(Object value, String format) {
        ...
        try {
            ...
            logger.error("normalize value error, ", e);
        }
...
//                    }
                    ...
                    try {
                        ...
                        logger.error("normal date e2 error, ", e2);
                    }
                }
...
//                        注意时间戳类型: 1581752356000
            ...
            logger.error("normal date error, ", e);
            return null;
        }
    }
