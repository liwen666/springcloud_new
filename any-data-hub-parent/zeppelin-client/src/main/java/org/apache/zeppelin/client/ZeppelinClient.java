...
public class ZeppelinClient {
    ...
    private void checkResponse(HttpResponse<JsonNode> response) throws Exception {
        ...
        if (response.getStatus() != 200) {
            ...
            if (ObjectUtils.allNotNull(response, response.getBody()) && response.getBody().getObject() != null &&
     ...
     * @throws Exception
     */
    public String deleteParagraph(String noteId, String paragraphId) throws Exception {
        HttpResponse<JsonNode> response = Unirest
        ...
        return jsonNode.getObject().getString("status");
    }
    ...
    /**
     * listInterpreterSettings
     */
    public void listInterpreterSettings() throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/interpreter/setting")
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        JSONArray settingJSONArray = jsonNode.getObject().getJSONArray("body");
        LOGGER.info("list settings. \n {}" + settingJSONArray.toString());
    }

    /**
     * listInterpreter
     */
    public JSONObject listInterpreter() throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/interpreter")
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        JSONObject respJSON = jsonNode.getObject().getJSONObject("body");

        LOGGER.info("list interpreter. {}", respJSON);
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public JSONObject getInterpreterSetting(String settingId) throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/interpreter/setting/{settingId}")
                .routeParam("settingId", settingId)
                .asJson();
        ...
        LOGGER.info("get interpreter setting【{}】.", respJSON);
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public JSONObject newInterpreterSettings(String messageJSON) throws Exception {
        HttpResponse<JsonNode> response = Unirest
        ...
        LOGGER.info("new interpreter settings.\n {}", respJSON);
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public JSONObject updateInterpreterSetting(String message, String settingId) throws Exception {
        LOGGER.info("update interpreter setting. settingId: {}, message: {}", settingId, message);

        JSONObject bodyObject = new JSONObject();
        HttpResponse<JsonNode> response = Unirest
                .post("/interpreter/setting/{settingId}")
                .routeParam("settingId", settingId)
                .body(message)
                .asJson();
        ...
        LOGGER.info("update interpreter setting【{}】success. \n {}", settingId, respJSON);
        return respJSON;
     ...
     * @throws Exception
     */
    public void removeInterpreterSetting(String settingId) throws Exception {
        LOGGER.info("remove interpreter setting. {}", settingId);
        HttpResponse<JsonNode> response = Unirest
                .delete("/interpreter/setting/{settingId}")
                .routeParam("settingId", settingId)
                .asJson();
        ...
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        String respStatus = jsonNode.getObject().getString("status");
    }
     ...
     * @throws Exception
     */
    public JSONObject restartInterpreterSetting(String message, String settingId) throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .post("/interpreter/setting/restart/{settingId}")
                .routeParam("settingId", settingId)
                .body(message)
                .asJson();
        ...
        LOGGER.info("restart interpreter setting【{}】respStatus success.", settingId);
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public JSONObject listInterpreterRepositories() throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/interpreter/repository")
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        ...
        LOGGER.info("list interpreter repositories.\n{}", respJSON);
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public void addInterpreterRepository(String message) throws Exception {
        JSONObject bodyObject = new JSONObject();
        HttpResponse<JsonNode> response = Unirest
                .post("/interpreter/repository")
                .body(message)
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        ...
        LOGGER.info("add interpreter repository.\n{}", respJSON);
    }
     ...
     * @throws Exception
     */
    public void removeInterpreterRepository(String repoId) throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .delete("/interpreter/repository/{repoId}")
        ...
        LOGGER.info("remove interpreter repository.\n{}", respJSON);
    }

    /**
     * listInterpreterPropertyTypes
     *
     * @throws Exception
     */
    public void listInterpreterPropertyTypes() throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/interpreter/property/types")
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        ...
        LOGGER.info("list interpreter property types.\n{}", respJSON);
    }
     ...
     * @param message
     */
    public void installInterpreter(String message) throws Exception {
        JSONObject bodyObject = new JSONObject();
        HttpResponse<JsonNode> response = Unirest
                .post("/interpreter/install")
                .body(message)
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        ...
        LOGGER.info("install interpreters success.");
    }
     ...
     * @throws Exception
     */
    public JSONArray getNoteList() throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/notebook")
                .asJson();
        checkResponse(response);
        JsonNode jsonNode = response.getBody();
        checkJsonNodeStatus(jsonNode);
        JSONArray respJSON = jsonNode.getObject().getJSONArray("body");
        return respJSON;
    }
     ...
     * @throws Exception
     */
    public JSONObject getNote(String noteId) throws Exception {
        HttpResponse<JsonNode> response = Unirest
                .get("/notebook/{noteId}")
                .routeParam("noteId", noteId)
                .asJson();
