...
import com.riveretech.flink.prolate.ProrateJobLodes;
...
@EnableBatchTask
public class BlinkBatchJobApplication {

    private static final Logger logger = LoggerFactory.getLogger(BlinkBatchJobApplication.class);


    /**
     * @EnableBatchTask 下面是作为springbatch方式拉起任务执行，并关闭
     */
    public static void main(String[] args) throws NoSuchMethodException, ClassNotFoundException {
        ProrateJobLodes.load(args);
//        System.out.println(Class.forName("com.riveretech.flink.upgrade.job.FileTaskletJobConfiguration"));
...
//        list.add("--task.jobName=customTaskletJob" );
        ...
        logger.info("========simple job 执行任务参数是" + JSON.toJSONString(args));
        try {
            new SpringApplicationBuilder(BlinkBatchJobApplication.class)
