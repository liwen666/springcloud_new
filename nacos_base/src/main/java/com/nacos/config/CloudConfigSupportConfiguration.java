...
public class CloudConfigSupportConfiguration implements
    ...
    Logger logger = LoggerFactory.getLogger(CloudConfigSupportConfiguration.class);
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        logger.info("加载PropertySources源：" + propertySources.size() + "个");
                ...
                PropertySource backupSource = new MapPropertySource("backupSource", new HashMap(){{put("server.port","20000");}});
