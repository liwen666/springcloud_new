...
public class RbacServiceImpl implements RbacService {
      ...
      public static void main(String[] args) {
            ...
            System.out.println(antPathMatcher.match("a*bc","abc"));
            System.out.println(antPathMatcher.match("a*.c","abc"));
            System.out.println(antPathMatcher.match("aBc","abc"));
            System.out.println(antPathMatcher.match("ab c","abc"));
            System.out.println(antPathMatcher.match("a*cc","abc"));
      }
}
