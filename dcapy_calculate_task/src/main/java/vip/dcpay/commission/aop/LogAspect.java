package vip.dcpay.commission.aop;
...
public class LogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(vip.dcpay.commission.aop.annotation.CalculateLog)")
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) {
        ...
        Annotation annotation = method.getAnnotation(CalculateLog.class);
        String description = null;
        if (null!=annotation) {
            description = ((CalculateLog) annotation).description();
        }
        Object result = null;
        ...
        try {
            ...
            return Result.error(description+" 异常");
        }
        return result;
    }
