...
@Service
public class BaseZookeeper implements Watcher, BeanDefinitionRegistryPostProcessor, ImportBeanDefinitionRegistrar, EnvironmentAware {
...
//    private static final int SESSION_TIME_OUT = 2000;
    ...
    public void setEnvironment(Environment environment) {
        String zookeeperAddr = environment.getProperty("zookeeper.addr");
        try {
            connectZookeeper(zookeeperAddr);
        } catch (Exception e) {
            e.printStackTrace();
        }
