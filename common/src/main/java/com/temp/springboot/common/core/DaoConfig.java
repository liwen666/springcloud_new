...
//@Slf4j
//@Configuration
//@MapperScan(basePackages="com.temp.springboot.common.dcpay.dao",markerInterface= BaseMapper.class)
...
//		sqlSessionFactory.setTypeAliasesPackage("com.temp.springboot.common.dcpay.domain");// 配置实体扫描路径，多个package可以用“分号;”或“逗号,” 分隔， 支持通配符*
//
//		// 插件配置
//
