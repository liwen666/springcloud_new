...
//		d.setDriverClassName("com.mysql.jdbc.Driver");
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
		PropertiesConfigurer prop = mysqlPropertiesConfigurer();
		// 构造工厂
	...
	@Bean
	public PropertiesConfigurer mysqlPropertiesConfigurer() {
		PropertiesConfigurer prop = new PropertiesConfigurer();
		prop.setIgnoreUnresolvablePlaceholders(true);
		prop.setIgnoreResourceNotFound(true);
		prop.setLocations(new ClassPathResource("mysqljdbc.properties"));
		return prop;
	}

	@Bean("mysqlJdbcTemplate")
	public JdbcTemplate mysqljdbcTemplate(@Qualifier("msqldataSource") DataSource dataSource){
	...
	@Bean("msqldataSource")
	public DruidDataSource msqldataSource() {
		DruidDataSource d = new DruidDataSource();
		PropertiesConfigurer prop = mysqlPropertiesConfigurer();
		String url = prop.getProperty("db.url");
		String username = prop.getProperty("db.username");
