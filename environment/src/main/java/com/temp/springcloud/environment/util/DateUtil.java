package com.temp.springcloud.environment.util;
...
public class DateUtil {
	...
	private static Date rollDay(Date pDate, int pDay) {
	...
	public static String formatDateTime(Date p1) {
		if (p1 != null)
	...
	public static String formatLongDate(Date p1) {
		if (p1 != null)
	...
	public static String formatLongDateTime(Date p1) {
		if (p1 != null)
	...
	public static Date parseDate(String p1)
	...
	public static Date parseDateTime(String p1)
			throws ParseException {
	...
	public static Date convertSqlToUtilDate(java.sql.Date p1) {
		return new Date(p1.getTime());
	}

	public static java.sql.Date convertUtilToSqlDate(Date p1) {
